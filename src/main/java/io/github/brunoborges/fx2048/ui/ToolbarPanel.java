...
public final class ToolbarPanel extends HBox {
    ...
    public ToolbarPanel(Actions actions, ObservableIntegerValue undoCount, ObservableBooleanValue undoAvailable) {
        super();
    ...
    public void bindSpacingTo(ObservableNumberValue width) {
